...
using JLD2
# jldsave("article/popdyn_infinite_er_disordered_posneg_beta0,5_dmax$(bonddims[end])_K$(K).jld2"; bs, bs2times, bs2vars)
jldsave("article/monte_carlo_infinite_er_disordered_posneg_beta0,5_Nmc$(Nmc)_nsamp$(nsamples).jld2"; m_mc, autocorr_mc, energy_mc)