...
using JLD2
jldsave("article/tree_$(N)_beta0,5_h0_randomJ.jld2"; m_fourier, energy_fourier, J)
jldsave("article/monte_carlo_tree_$(N)_randomJ_beta0,5_h0_nsamp$(nsamples).jld2"; m_mc, energy_mc)
...
using JLD2
jldsave("tree_$(N)_beta0,5_h0_randomJ_conv.jld2"; m_fourier, energy_fourier, J)
jldsave("monte_carlo_tree_$(N)_randomJ_beta0,5_h0_nsamp$(nsamples)_conv.jld2"; m_mc, energy_mc)